  ...
  <body>
   	<div id="middle">
  		<div class="right"  id="mainFrame">
			<form action="${pageContext.request.contextPath}/user_changePassword.action" method="post" id="addForm">
				    ...
				    <div class="content-box-header">
			   		...
			   		<div style="width:600px; margin:0 auto; margin-top:60px;">
			            ...
			            <tr>
			                ...
			                <td >
			                	<input type="text" value="${login_user.userName }" tabindex="0"  style="width:200px;margin-left:30px;" readonly="readonly"/>
			                </td>
			              </tr>
			              <tr>
