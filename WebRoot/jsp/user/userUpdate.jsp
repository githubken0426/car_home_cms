  ...
  <body>
   	<div id="middle">
  		<div class="right"  id="mainFrame">
			<form action="${pageContext.request.contextPath}/user_updateUser.action" method="post" id="updateForm">
			   <div class="content-box">
				    <div class="content-box-header">
				    	<span class="now_location">当前位置:</span> 修改用户信息
				        <div class="clear"></div>
				    </div>
			            ...
			            <table class="table table-bordered" >
			              <tr>
			                ...
			                <td >
			                	...
			                	<input type="text" name="user.userName" id="userName" value="${user.userName }" tabindex="1"  style="width:200px;margin-left:30px;"/>
			              ...
			              <tr>
			                ...
			                <td>
			                	<input type="text" id="password" name="user.password" value="${user.password }" tabindex="2" style="width:200px;margin-left:30px;"/>
			              ...
			              <!-- tr>
			                ...
			                <td>
			                	<input type="text" name="againPassword" id="againPassword" tabindex="3" style="width:200px;margin-left:20px;"/>
			    		  ...
			    		  <tr>
			                ...
			                <td>
			                	<input type="text" name="user.realName" id="realName" value="${user.realName }"  tabindex="4" style="width:200px;margin-left:30px;"/>
			                </td>
			              </tr>
			              <tr>
			                ...
			                <td>
			                	<select name="user.groupId" id ="userGroups" style="width:210px;margin-left:30px;height:26px;" tabindex="5"  >
			                		...
			                		<c:forEach var="group" items="${groupList}">
			                			<option value="${group.id }"<c:if test="${group.id==user.groupId }">selected="selected"</c:if>>${group.groupName }</option>
			                		</c:forEach>
			                	</select>
			                </td>
			              </tr>
			                ...
			                <td>
			                	<c:choose>
			                		...
			                		<c:when test="${user.status==1}">
			                			<label style="margin-left: 35px; display: inline;">
					                		<input type="radio" name="user.status" value="0"/><span style="margin-left: 10px;">启&nbsp;用</span>
					                	</label>
					                	<label style="margin-left: 25px;display: inline;">
					                		<input type="radio" name="user.status" checked="checked" value="1"/><span style="margin-left: 10px;">禁&nbsp;用</span>
					                	</label>
			                		</c:when>
			                		<c:otherwise>
			                			<label style="margin-left: 35px; display: inline;">
			              ...
			              <table  class="margin-bottom-20 table  no-border" style="margin-top:50px;">
			                <tr>
			     	         <td class="text-center">
			     	         	<input type="button" value="确定" class="btn btn-info " style="width:80px;" onclick="updateSubmit()" />
			     	         </td>
			     	         <td align="left">
