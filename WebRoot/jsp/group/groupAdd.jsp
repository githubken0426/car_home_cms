  ...
  <body>
   	<div id="middle">
  		<div class="right"  id="mainFrame">
			<form action="${pageContext.request.contextPath}/group_addGroup.action" method="post" id="addForm">
			   <div class="content-box">
				    <div class="content-box-header">
				    	<span class="now_location">当前位置:</span> 添加用户组
				        <div class="clear"></div>
				    </div>
			   		<div style="width:100%; margin:0 auto; margin-top:30px;">
			            <table class="table table-bordered" >
			              <tr>
			                ...
			                <td >
			                	<input type="text" name="group.groupName" id="groupName" tabindex="1"  style="width:200px;margin-left:30px;"/>
			              ...
			              <tr>
			                ...
			                <td>
			                	<textarea id="roupContent" name="group.groupContent"  style="width:700px;height:80px;margin-left:30px;resize: none;"></textarea>
			                </td>
			              </tr>
			              </table>
