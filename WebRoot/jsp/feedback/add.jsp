...
<div id="middle">
	<div class="right"  id="mainFrame">
		<form action="${pageContext.request.contextPath}/feedbackAction!addData.action" method="post" id="addForm">
		   		...
		   		<div style="margin:0 auto; margin:10px;">
	            	...
	            	<table class="table table-bordered" >
						...
						<tr>
							...
							<td>
							<input type="text" id="content" name="entity.content" tabindex="2" style="width:400px;margin-left:30px;"/>
						...
						<tr>
							...
							<td>
							<input type="text" id="mail" name="entity.mail" tabindex="3" style="width:400px;margin-left:30px;"/>
						...
						<tr>
							...
							<td>
							<input type="text" id="reply" name="entity.reply" tabindex="4" style="width:400px;margin-left:30px;"/>
