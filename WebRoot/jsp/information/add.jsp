...
<div id="middle">
	<div class="right"  id="mainFrame">
		<form enctype="multipart/form-data" action="${pageContext.request.contextPath}/information_addData.action" method="post" id="addForm">
		   		...
		   		<div style="margin:0 auto; margin:10px;">
	            	<table class="table table-bordered" >
						...
						<tr>
							...
							<td width="38%">
								<input type="text" id="resource" name="information.resource" tabindex="3" style="width:200px;margin-left:30px;"/>
							</td>
							<td width="12%" align="right" nowrap="nowrap" bgcolor="#f1f1f1" height="40px">状态：</td>
							<td width="38%">
								<label style="margin-left: 35px; display: inline;">
			                		<input type="radio" name="information.deleteFlag" checked="checked" tabindex="6"  value="0" style="margin-top:0px;"/>
			                		<span style="margin-left: 10px;">启&nbsp;用</span>
			                	</label>
			                	<label style="margin-left: 25px;display: inline;">
			                		<input type="radio" name="information.deleteFlag" value="1" tabindex="7" style="margin-top:0px;"/>
			                		<span style="margin-left: 10px;">禁&nbsp;用</span>
			                	</label>
							</td>
						</tr>
						<tr>
							<td width="15%" align="right" nowrap="nowrap" bgcolor="#f1f1f1" height="40px">资讯标题：</td>
							<td colspan="3">
								<input type="text" id="title"placeholder="标题在100字以内" name="information.title" tabindex="3" style="width:600px;margin-left:30px;"/>
						...
						<tr>
							...
							<td colspan="3">
								<textarea placeholder="简介在300字以内" id="introduction" name="information.introduction" tabindex="4" maxlength="300"
						...
						<tr>
							...
							<td colspan="3" style="white-space:pre-wrap">
								<script name="information.content" id="editor" type="text/plain" style="width:1024px;height:600px;margin-left:30px;"></script>
							</td>
						</tr>
	            	</table>
