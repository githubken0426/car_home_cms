	...
	$(function(){		
		...
		$("#cityCode").bind({
			focus:function(){
				...
				var cityCodeHid = $.trim($("#cityCodeHid").val());
				$.ajax({
			        type:"POST",  
			        dataType:"json",  
			        ...
			        success: function (data) {
			        	if(data==1 && cityCode != cityCodeHid){
		...
		$("#cityName").bind({
			focus:function(){
				...
				var cityNameHid = $.trim($("#cityNameHid").val());
				$.ajax({
			        type:"POST",  
			        dataType:"json",  
			        ...
			        success: function (data) {
			        	if(data==1 && cityName != cityNameHid){
...
<div id="middle">
	<div class="right"  id="mainFrame">
		<form action="${pageContext.request.contextPath}/city!updateData.action" method="post" id="updateForm">
			<div class="content-box">
			    ...
			    <div style="margin:0 auto; margin:10px;">
	            	...
	            	<table class="table table-bordered" >
	            		...
	            		<input type="hidden" id="cityCodeHid" name="cityCodeHid" value="${cityCodeHid}" />
	            		<input type="hidden" id="cityNameHid" name="cityNameHid" value="${cityNameHid}" />
						...
						<tr>
							...
							<td>
							<input type="text" id="cityCode" name="entity.cityCode" disabled="disabled" value="${entity.cityCode }"  tabindex="1" style="width:400px;margin-left:30px;"/>
						...
						<tr>
							...
							<td>
							<input type="text" id="cityName" name="entity.cityName"  value="${entity.cityName }"  tabindex="2" style="width:400px;margin-left:30px;"/>
