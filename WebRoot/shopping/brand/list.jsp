			    ...
			    <table class="table table-bordered table-striped table-hover">
		      	<tbody>
			        <tr align="center">
						...
						<!--  检索结果表格题头 -->
						<td nowrap="nowrap" width="120px"><strong>品牌中文名称</strong></td>
						<td nowrap="nowrap" width="220px"><strong>品牌英文名称</strong></td>
						<td nowrap="nowrap" width="220px"><strong>品牌logo</strong></td>
						<td nowrap="nowrap" width="70px"><strong>品牌介绍</strong></td>
						<td nowrap="nowrap" width="70px"><strong>品牌产品图片</strong></td>
	       			</tr>
